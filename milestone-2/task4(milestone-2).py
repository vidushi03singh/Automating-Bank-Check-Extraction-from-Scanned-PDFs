...
# Search checks
search_params = {'payee': 'Rajarshi'}
search_results = search_checks(database_path, search_params)
print("Search Results:", search_results)

# Update a check
update_fields = {'payee': 'New Payee Name'}
update_check(database_path, check_id=1, update_fields=update_fields)

# Delete a check
delete_check(database_path, check_id=2)

# Export to CSV
export_to_csv(database_path, csv_file_path)

# Get summary statistics
summary_stats = get_summary_statistics(database_path)
